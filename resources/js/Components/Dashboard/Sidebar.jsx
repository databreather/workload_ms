        ...
        <aside className="sidenav bg-default navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            <div className="sidenav-header">
                ...
                <Link className="navbar-brand m-0" href={route('home')} target="_blank">
                    ...
                    <span className="ms-1 font-weight-bold">Workload Management System</span>
                </Link>
            </div>
            ...
            <div className="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item mt-3">
                        <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Manage Loads</h6>
                    </li>                    
                    {/* <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <Link className={`${route().current('teaching_load.*') && 'active'} nav-link`} href={route('teaching_load.index')}>
                            <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i className="fas fa-user-lock text-warning text-sm opacity-10" />
                            </div>
                            <span className="nav-link-text ms-1">Teaching</span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link className={`${route().current('#') && 'active'} nav-link`} href="#">
                            <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i className="fas fa-user-lock text-warning text-sm opacity-10" />
                            </div>
                    ...
                    <li className="nav-item">
                        <Link className={`${route().current('#') && 'active'} nav-link`} href="#">
                            ...
                            <span className="nav-link-text ms-1">Administrative</span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link className={`${route().current('#') && 'active'} nav-link`} href="#">
                            ...
                            <span className="nav-link-text ms-1">Community Engagement</span>
                        </Link>
                    </li>
                    <li className="nav-item mt-3">
