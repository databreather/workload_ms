...
export default function CreateLoad({close}) {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        post(route('teaching_load.store'), {
            data, 
            onSuccess: () => {
                reset(),
                close()
            ...
            <form onSubmit={onSubmit}>
                <div className="modal-body">
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-select" name='mgc' id='mgc' value={data.mgc} onChange={onChange} aria-label="Default select example">
                                <option defaultValue="Choose Option">Choose Option</option>
