        ...
        <>
            <div>
                <main className="main-content  mt-0">
                    <div className="page-header align-items-start min-vh-50 blue pt-5 pb-11 m-3 border-radius-lg">
                    <div className="container">
                        <div className="row justify-content-center">
                        <div className="col-lg-5 text-center mx-auto">
                            <img src="/img/nust_logo.png" className="position-relative" width='300'/>
                        </div>
                        </div>
                    </div>
                    </div>
